...
class ci_provincia extends sicd_ci
{
	protected $s__where;
	...
	function evt__procesar()
	{
		try{
			...
			{
				toba::notificacion()->agregar("El tipo de documento esta siendo referenciada, no puede eliminarla",'error');
				
			} 
			if($sql_state=='23505')
			{
				toba::notificacion()->agregar("El provincia ya esta registrado.",'info');
	...
	function evt__cuadro__borrar($seleccion)
	{
		...
		try{
			...
			if($sql_state=='db_23503')
			{
				toba::notificacion()->agregar("El provincia esta siendo referenciada, no puede eliminarla",'error');
