<?php
 ...
 toba::memoria()->set_dato_instancia('instancia', toba::instancia()->get_id());
  ...
  //-- Se pide la url de la operaciÃ³n prinicipal de toba_usuarios
  $url = toba::vinculador()->get_url('toba_usuarios', '1000228', array(),
          array('celda_memoria' => 'usuarios'));
  if (isset($url) || $url != '') {
      echo toba_js::abrir();
      echo "
     ...
     echo toba_js::cerrar();
      ...
      throw new toba_error('Para administrar usuarios es necesario tener cargado el '.
          'proyecto toba_usuarios en la instancia junto a NOMBRE DE TU PROYECTO');
}
?>
