...
-- Started on 2018-04-27 06:39:55 -03
...
--
-- TOC entry 3243 (class 0 OID 31515)
-- Dependencies: 233
-- Data for Name: cabecera; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cabecera (logo1, logo2, nombre, descripcion) FROM stdin;
...
--
-- TOC entry 3234 (class 0 OID 30174)
-- Dependencies: 224
-- Data for Name: cargo_por_persona; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cargo_por_persona (idpersona, identidad, idtipo_cargo, cantidad_horas, fecha_inicio, fecha_fin, activo, idtipo_hora, tipo, idcargo_por_persona, bloque, historico, observaciones, monto, idfuente_financiamiento) FROM stdin;
1	11	3	21	2017-03-24	2018-03-31	t	\N	cargo	19	bloque1	f	\N	\N	\N
1	11	\N	15	2017-03-24	\N	t	1	horas	21	bloque2	f	\N	\N	\N
4	10	\N	15	2017-03-24	2018-03-31	t	2	horas	22	bloque1	f	\N	\N	\N
4	10	7	21	2017-03-24	\N	t	\N	cargo	24	bloque2	f	\N	\N	\N
1	10	\N	6	2017-03-08	2018-02-26	t	2	horas	20	bloque2	f	\N	\N	\N
7	10	4	21	2017-03-24	\N	t	\N	cargo	26	bloque1	f	\N	999999.800000000047	\N
6	11	5	21	\N	\N	t	\N	cargo	32	bloque2	f	\N	\N	\N
6	11	5	21	\N	\N	t	\N	cargo	33	bloque1	f	\N	\N	\N
4	7	\N	9	2018-02-22	\N	t	1	horas	23	bloque1	f	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public.cargo_por_persona_idcargo_por_persona_seq', 33, true);


--
-- TOC entry 3209 (class 0 OID 30024)
-- Dependencies: 199
-- Data for Name: configuracion; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.configuracion (cantidad_max_dias_viatico_mensual, cantidad_max_hs_bloque, cantidad_max_cargos_bloque) FROM stdin;
15	21	1
\.


--
-- TOC entry 3238 (class 0 OID 31345)
-- Dependencies: 228
-- Data for Name: detalle_dias_viatico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.detalle_dias_viatico (iddetalle_dias_viatico, fecha_desde, fecha_hasta, cantidad_dias, idlocalidad_origen, idlocalidad_destino, idviatico, medio_dia) FROM stdin;
...
8	2017-11-11	2017-11-09	3	218	264	9	f
...
22	2018-02-07	2018-02-09	14.5	193	193	16	f
23	2018-02-05	2018-02-05	0.5	193	193	12	f
24	2018-03-16	2018-03-16	0.5	193	193	9	f
25	2018-02-20	2018-02-23	0.5	193	193	16	f
\.
...
SELECT pg_catalog.setval('public.detalle_dias_viatico_iddetalle_dias_viatico_seq', 25, true);


--
-- TOC entry 3236 (class 0 OID 30197)
-- Dependencies: 226
-- Data for Name: detalle_viatico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.detalle_viatico (iddetalle_viatico, monto, descripcion, idtipo_detalle_viatico, idviatico) FROM stdin;
1	500	\N	2	1
1	500	\N	2	1
2	500	\N	2	8
\.
...
SELECT pg_catalog.setval('public.detalle_viatico_iddetalle_viatico_seq', 2, true);


--
-- TOC entry 3223 (class 0 OID 30082)
-- Dependencies: 213
-- Data for Name: entidad; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.entidad (identidad, sigla, nombre, idlocalidad, calle, altura, piso, depto) FROM stdin;
1	UNAM	UNIVERSIDAD NACIONAL DE MISIONESMISIONESMISMISIONMISIONESMISIONESESMISIONESIONES	218	\N	\N	\N	\N
2	UNCAUS	UNIVERSIDAD DEL CHACO AUSTRAL	218	DSDF	22	A	A
4	\N	FSDFSDSDF	\N	\N	\N	\N	\N
5	\N	UNIVERSIDAD DEL CHACO AUSTRAL4	\N	\N	\N	\N	\N
6	\N	FGHGFH	\N	\N	\N	\N	\N
7	\N	FGGDGD	\N	\N	\N	\N	\N
9	\N	GFGHJ,HKHJ	\N	\N	\N	\N	\N
8	\N	ZCZCX	194	\N	98754	\N	\N
10	\N	ADS	\N	\N	\N	\N	\N
11	\N	EREREE	\N	\N	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public.entidad_identidad_seq', 11, true);


--
-- TOC entry 3225 (class 0 OID 30090)
-- Dependencies: 215
...
SELECT pg_catalog.setval('public.estado_civil_idestado_civil_seq', 9, true);


--
-- TOC entry 3240 (class 0 OID 31371)
-- Dependencies: 230
-- Data for Name: estudio; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.estudio (titulo, idestudio, sigla) FROM stdin;
...
SELECT pg_catalog.setval('public.estudio_idestudio_seq', 3, true);


--
-- TOC entry 3242 (class 0 OID 31395)
-- Dependencies: 232
-- Data for Name: estudio_por_persona; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.estudio_por_persona (idestudio, idnivel_estudio, idpersona, identidad, obervaciones) FROM stdin;
1	7	4	1	DFGDDG
1	7	1	2	\N
1	7	1	1	\N
2	7	4	2	\N
...
--
-- TOC entry 3247 (class 0 OID 45228)
-- Dependencies: 437
-- Data for Name: fuente_financiamiento; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.fuente_financiamiento (idfuente_financiamiento, sigla, nombre) FROM stdin;
7	\N	AAAAAAAAAAAAAAQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ                                                                                                                                                                                                                             
4	RGETR     	ASDAFDGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN                                                                                                                                                                                                  
6	A         	HTTYTDHGGGGGGGGGGGGGGGGGGGGGGGGBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY                                                                                                                                                              
\.
...
-- Dependencies: 438
-- Name: fuente_financiamiento_idfuente_financiamiento_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.fuente_financiamiento_idfuente_financiamiento_seq', 7, true);


--
-- TOC entry 3213 (class 0 OID 30037)
-- Dependencies: 203
-- Data for Name: funcion; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.funcion (idfuncion, descripcion, maximo_horas, cantidad_permitida) FROM stdin;
1	PROFESIONAL	10	2
\.
...
SELECT pg_catalog.setval('public.funcion_idfuncion_seq', 1, true);


--
-- TOC entry 3221 (class 0 OID 30074)
-- Dependencies: 211
...
SELECT pg_catalog.setval('public.localidad_idlocalidad_seq', 450, true);


--
-- TOC entry 3208 (class 0 OID 30018)
-- Dependencies: 198
-- Data for Name: nivel_estudio; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.nivel_estudio (idnivel_estudio, descripcion, maximo_horas, orden, nivel) FROM stdin;
7	UNIVERSITARIO	20	1	SUPERIOR
6	SECUNDARIO	20	2	SUPERIOR
5	PRIMARIOSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS	10	3	INFERIOR
\.
...
SELECT pg_catalog.setval('public.nivel_estudio_idnivel_estudio_seq', 7, true);


--
-- TOC entry 3217 (class 0 OID 30058)
-- Dependencies: 207
...
SELECT pg_catalog.setval('public.pais_idpais_seq', 20, true);


--
-- TOC entry 3231 (class 0 OID 30114)
-- Dependencies: 221
-- Data for Name: persona; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.persona (idpersona, nombres, apellido, idtipo_documento, nro_documento, matricula, idestado_civil, cuil, correo, fecha_nacimiento, sexo, idlocalidad, calle, altura, depto, piso, domicilio, matricula_activa, fecha_baja_matricula, baja) FROM stdin;
...
7	LIONEL	MESSI	7	45254555	\N	2	\N	\N	\N	m	193	CALLEA	5454	\N	\N	\N	t	\N	f
1	GUSTAVO CESAR EMPERADOR	ESCALANTE	7	30047529	644	6	20304752190	escalantegc@gmail.com	2000-03-16	m	218	CALLEA	1538	22	1	QA	f	\N	f
6	ROMINA	RIVERO	7	30361545	\N	\N	20304752190	\N	\N	f	194	CALLE	1538	\N	\N	\N	t	\N	f
\.
...
SELECT pg_catalog.setval('public.persona_idpersona_seq', 7, true);


--
-- TOC entry 3219 (class 0 OID 30066)
-- Dependencies: 209
-- Data for Name: provincia; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.provincia (idprovincia, idpais, descripcion) FROM stdin;
2	2	ENTRE RIOS
3	2	BUENOS AIRES
4	2	CATAMARCA
5	2	CHACO
...
SELECT pg_catalog.setval('public.provincia_idprovincia_seq', 64, true);


--
-- TOC entry 3237 (class 0 OID 30219)
-- Dependencies: 227
-- Data for Name: telefono_por_persona; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.telefono_por_persona (idtipo_telefono, idpersona, numero) FROM stdin;
2	1	367689846
2	4	37648945
2	1	367689846
2	4	37648945
...
--
-- TOC entry 3227 (class 0 OID 30098)
-- Dependencies: 217
-- Data for Name: tipo_cargo; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tipo_cargo (idtipo_cargo, descripcion, cantidad_cargos, jerarquico) FROM stdin;
...
SELECT pg_catalog.setval('public.tipo_cargo_idtipo_cargo_seq', 7, true);


--
-- TOC entry 3211 (class 0 OID 30029)
-- Dependencies: 201
-- Data for Name: tipo_detalle_viatico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tipo_detalle_viatico (idtipo_detalle_viatico, descripcion) FROM stdin;
2	COMBUSTIBLE
3	HOSPEDAJE
1	SIN MOTIVOS
\.
...
SELECT pg_catalog.setval('public.tipo_detalle_viatico_idtipo_detalle_viatico_seq', 3, true);


--
-- TOC entry 3229 (class 0 OID 30106)
-- Dependencies: 219
...
SELECT pg_catalog.setval('public.tipo_documento_idtipo_documento_seq', 8, true);


--
-- TOC entry 3244 (class 0 OID 42562)
-- Dependencies: 234
-- Data for Name: tipo_hora; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tipo_hora (idtipo_hora, descripcion, max_hs_nivel_medio, max_hs_nivel_superior) FROM stdin;
2	NIVEL MEDIO                                       	12	0
...
SELECT pg_catalog.setval('public.tipo_hora_idtipo_hora_seq', 3, true);


--
-- TOC entry 3215 (class 0 OID 30050)
-- Dependencies: 205
...
SELECT pg_catalog.setval('public.tipo_telefono_idtipo_telefono_seq', 4, true);


--
-- TOC entry 3233 (class 0 OID 30125)
-- Dependencies: 223
-- Data for Name: viatico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.viatico (idviatico, fecha_desde, nro_expediente, fecha_hasta, idpersona, idlocalidad_origen, idlocalidad_destino, cantidad_total_dias, mes, cantidad_dias_reintegro, cantidad_dias_disponible, cantidad_dias_tomados) FROM stdin;
...
14	\N	888	\N	1	\N	\N	15	3 	0	15	0
17	\N	9547	\N	1	\N	\N	15	1 	0	13	2
8	\N	989	\N	1	\N	\N	10	1 	0	9	1
15	\N	7987	\N	1	\N	\N	15	1 	0	15	0
19	\N	46511	\N	6	\N	\N	15	3 	0	13	2
7	\N	88888888ff	\N	1	\N	\N	10	1 	0	10	0
12	\N	11789	\N	1	\N	\N	15	11	3	8	4
9	\N	164	\N	1	\N	\N	15	10	0	11.5	3.5
16	\N	2146	\N	1	\N	\N	15	1 	0	0	15
21	\N	533	\N	7	\N	\N	15	1 	0	15	0
18	\N	647	\N	4	\N	\N	15	3 	0	13	2
\.
...
SELECT pg_catalog.setval('public.viatico_idviatico_seq', 21, true);
...
-- Completed on 2018-04-27 06:39:55 -03
